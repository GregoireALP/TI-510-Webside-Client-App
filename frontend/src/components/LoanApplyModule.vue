        ...
        <div class="form-row">
            ...
            <div class="container mt-4">
                ...
                <div class="input-group">
                  <input type="nuber" id="amount_input" class="form-control" aria-label="Amount (to the nearest dollar)" min="0.01" placeholder="0.00" required oninvalid="this.setCustomValidity('Enter an amount')" oninput="this.setCustomValidity('')">
            ...
            <div class="container mt-4">
                <button id="button_submit_loan" type="submit">Submit Request</button>
            </div>
        </div>
    </form>
    <div class="loan_info">
