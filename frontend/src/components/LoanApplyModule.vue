            ...
            <div class="form-row">
                ...
                <div class="container mt-4">
                    ...
                    <div class="input-group">
                      <input type="number" id="amount_input" class="form-control" aria-label="Amount (to the nearest dollar)" min="0.01" placeholder="0.00" required oninvalid="this.setCustomValidity('Enter an amount')" oninput="this.setCustomValidity('')">
                ...
                <div class="container mt-4">
                    ...
                    <div class="input-group">
                      <input type="number" id="interest_input" class="form-control" aria-label="Interest" min="0.01" placeholder="0.00" required oninvalid="this.setCustomValidity('Enter an amount')" oninput="this.setCustomValidity('')">
                      <div class="input-group-append">
                        <span class="input-group-text">%</span>
                      </div>
                    </div>
                ...
                <div class="container mt-4">
                    ...
                    <textarea class="form-control" id="message_input" rows="7" placeholder="Enter your message ..."></textarea>
                </div>
                <div class="container mt-4">
                  <div class="form-check">
                    <input class="form-check-input" type="checkbox" value="" id="invalidCheck3" required oninvalid="this.setCustomValidity('Click on the button')" oninput="this.setCustomValidity('')">
                ...
                <div class="container mt-4">
                    <a id="button_submit_loan" class="btn" @click="processLoanRequest">Submit Request</a>
                </div>
            </div>
        </form>
        <div class="loan_info">
          ...
          <h4>Student Loan</h4>
          <p>Designed to help students cover tuition, books, and living expenses. Repayment is usually deferred until after graduation, making it easier to focus on your studies.</p>

          <h4>Consumption Loan</h4>
          <p>Ideal for covering personal expenses, like household purchases or unexpected costs. This loan has shorter repayment terms, making it suitable for immediate needs.</p>
